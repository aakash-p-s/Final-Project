...
class OTPScreenpickup extends StatefulWidget {
  final String email;
  final String otp;
  ...
  @override
  _OTPScreenpickupState createState() => _OTPScreenpickupState();
}

class _OTPScreenpickupState extends State<OTPScreenpickup> {
  ...
  Future<void> _verifyOTP(String otp) async {
    try {
      final response = await http.post(
        Uri.parse(
            'http://192.168.43.156:3000/api/pickup-verification/verify-otp'),
